...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3">
		...
		<body>
			...
			<div class="container border padding">
				...
				<div class="container border_bottom padding">
					<div class="row">
						<div class="col-md-12">
							<h4 style="text-align:center">住 院 病 案 首 页</h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 ">
					...
					<div class="row">
						<div class="col-md-4 ">
							<p class="text_left" style="color: red;">健康卡号:</p>
							<xsl:value-of select="n1:recordTarget/n1:patientRole/n1:id[@root='2.16.156.10011.1.19']/@extension"/>
						</div>
						<div class="col-md-4 text-center">
							<p>第 </p>
							<xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='11336-5']/n1:section/n1:entry/n1:observation/n1:value/@value"/>
					
							<p> 次 住 院</p>
						</div>
						<div class="col-md-4">
							<p class="text_left">病案号:</p>
							<xsl:value-of select="n1:recordTarget/n1:patientRole/n1:id[@root='2.16.156.10011.1.13']/@extension"/>
						</div>
					</div>
				</div>
				<!--患者信息-->
				...
				<div class="container padding">
					<div class="row">
						<div class="col-md-7">
							<strong>入院途径</strong>
							<p class="underline">
								<xsl:value-of select="n1:componentOf/n1:encompassingEncounter/n1:code/@displayName"/>
							</p>
						</div>
						<div class="col-md-5 ">
							<strong>入院时情况</strong>
					...
					<div class="row">
						<div class="col-md-5 ">
							<strong>入院时间</strong>
							<p class="underline">
								<xsl:value-of select="n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:low/@value"/>
							</p>
						</div>
						<div class="col-md-2 ">
							<strong>入院科别</strong>
							<p class="underline">
								<xsl:value-of select="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:serviceProviderOrganization/n1:asOrganizationPartOf/n1:wholeOrganization/n1:asOrganizationPartOf/n1:wholeOrganization/n1:name"/>
							</p>
						</div>
						<div class="col-md-2 ">
							<strong>病房</strong>
					...
					<div class="row">
						<div class="col-md-5 ">
							<strong>出院时间</strong>
							<p class="underline">
								<xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='8648-8']/n1:section/n1:entry/n1:act/n1:author/n1:time"/>
							</p>
						</div>
						<div class="col-md-2 ">
							<strong>出院科别</strong>
						...
						<div class="col-md-2 ">
							<strong>病房</strong>
							<p class="underline">
								<xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='8648-8']/n1:section/n1:entry/n1:act/n1:author/n1:assignedAuthor/n1:representedOrganization/n1:name"/>
							</p>
						</div>
						<div class="col-md-3 ">
							<strong>实际住院</strong>
					...
					<div class="row">
						...
						<div class="col-md-3 ">
							<strong>疾病编码</strong>
							<p class="underline">
								<xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='29548-5']/n1:section/n1:entry[position()=1]/n1:organizer/n1:component[position()=2]/n1:observation/n1:value/@code"/>
							</p>
						</div>
					</div>
					<div><xsl:apply-templates select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='29548-5']/n1:section"/></div>
				</div>
				<!--出院诊断表-->
			...
			<div class="container border_side padding" style="margin-top: -16px;">
				<div class="row">
					<div class="col-md-12 ">
						<strong>离院方式</strong>;
                    <xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='11535-2']/n1:section/n1:entry/n1:observation[n1:code/@code='DE06.00.223.00']/n1:value/@displayName"/>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 ">拟接受医疗机构名称：;<p class="underline">
					<xsl:value-of select="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='11535-2']/n1:section/n1:entry/n1:observation[n1:code/@code='DE06.00.223.00']/n1:entryRelationship/n1:observation/n1:value"/>
					</p>
					</div>
				</div>
			</div>
			...
			<div class="container border_no_bottom padding">
				<div class="row">
					...
					<div class="col-md-3 ">主(副主)任医师 :<p class="underline">
							<xsl:value-of select="n1:authenticator[n1:assignedEntity/n1:id/@extension='62459']/n1:assignedEntity/n1:assignedPerson/n1:name"/>
						</p>
					</div>
					<div class="col-md-3 ">主治医师 :<p class="underline">
							<xsl:value-of select="n1:authenticator[n1:assignedEntity/n1:id/@extension='76452']/n1:assignedEntity/n1:assignedPerson/n1:name"/>
						</p>
					</div>
					<div class="col-md-3 ">住院医师 :<p class="underline">
							<xsl:value-of select="n1:authenticator[n1:assignedEntity/n1:id/@extension='75508']/n1:assignedEntity/n1:assignedPerson/n1:name"/>
						</p>
					</div>
				</div>
				<div class="row">
	...
	<xsl:template match="n1:recordTarget/n1:patientRole/n1:patient">
		<div class="row">
			...
			<div class="col-md-2 form-group">
				<strong>性别</strong>
				<p class="underline">
					<xsl:value-of select="n1:administrativeGenderCode/@displayName"/>
				</p>
			</div>
			<div class="col-md-3 ">
				<strong>出生日期</strong>
				<p class="underline">
					<xsl:value-of select="n1:birthTime/@value"/>
				</p>
			</div>
			<div class="col-md-2 ">
				<strong>年龄</strong>
				<p class="underline">
					<xsl:value-of select="n1:age/@value"/>
				</p>
			</div>
			<div class="col-md-2 ">
				<strong>国籍</strong>
				<p class="underline">
					<xsl:value-of select="n1:nationality/@displayName"/>
				</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-3 ">
				<strong>年龄月</strong>
				<p class="underline"/>/30月</div>
			<div class="col-md-3 ">
				<strong>新生儿出生体重</strong>
				<p class="underline"/>克</div>
			<div class="col-md-3 ">
				<strong>新生儿入院体重</strong>
				<p class="underline">
					<xsl:value-of select="n1:componet/n1:structuredBody/n1:component/n1:section/n1:entry/n1:observation/n1:value/@value"/>
				</p>克</div>
		</div>
		<div class="row">
			<div class="col-md-5 ">
				<strong>出生地</strong>
				<p class="underline">
					<xsl:value-of select="n1:birthplace/n1:state"/>
					<xsl:value-of select="n1:birthplace/n1:city"/>
					<xsl:value-of select="n1:birthplace/n1:county"/>
				</p>
			</div>
			<div class="col-md-5 ">
				<strong>籍贯</strong>
		...
		<div class="row">
			<div class="col-md-10 ">
				<strong>户口地址</strong>
				<p class="underline">
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:state"/>
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:city"/>
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:county"/>
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:township"/>
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:streetName"/>
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:houseNumber"/>
				</p>
			</div>
			<div class="col-md-2 ">
				<strong>邮编</strong>
				<p class="underline">
					<xsl:value-of select="n1:household/n1:place/n1:addr/n1:postalCode"/>
				</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-7 ">
				...
				<p class="underline">
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:state"/>
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:city"/>
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:county"/>
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:township"/>
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:streetName"/>
					<xsl:value-of select="n1:employerOrganization/n1:addr/n1:houseNumber"/>
				</p>
			</div>
			<div class="col-md-3 ">
				<strong>单位电话</strong>
				<p class="underline">
					<xsl:value-of select="n1:employerOrganization/n1:telecom"/>
				</p>
			</div>
			<div class="col-md-2 ">
				<strong>邮编</strong>
			...
			<tbody>
				<xsl:for-each select="n1:entry">
					<tr>
						...
						<th class="border" style="width: 10%;">
							<p>
								<xsl:value-of select="n1:procedure/n1:entryRelationship/n1:observation[n1:code/@code='DE05.10.147.00']/n1:performer/n1:assignedEntity/n1:name"/>
							</p>
						</th>
					</tr>
				</xsl:for-each>
	...
	<xsl:template match="n1:component/n1:structuredBody/n1:component[n1:section/n1:code/@code='29548-5']/n1:section">
...
<xsl:value-of select="n1:entry/n1:organizer/n1:component[n1:observation/n1:code/@code='DE05.01.025.00']/n1:observation/n1:value"/>
							</p>
						</div>
						<div class="col-md-4 ">
