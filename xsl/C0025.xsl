						...
						<section>
							...
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="CD" code="{HealthGuidance/diet/Value}" displayName="{HealthGuidance/diet/displayName}" codeSystem="2.16.156.10011.2.3.1.263" codeSystemName="饮食指导代码表"/>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="HealthGuidance/lifestyle/Value"/></value>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="HealthGuidance/education/Value"/></value>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="HealthGuidance/followup/Value"/></value>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="ST"><xsl:value-of select="HealthGuidance/medication/Value"/></value>
								</observation>
							</entry>
						</section>
					</component>
						...
						<section>
							...
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<value xsi:type="CD" code="{HealthAssessment/selfcare/value}" displayName="{HealthAssessment/selfcare/Display}" codeSystem="2.16.156.10011.2.3.2.55" codeSystemName="自理能力代码表"/>
								</observation>
							</entry>
							<entry>
								<observation classCode="OBS" moodCode="EVN">
									...
									<!--HDSD00.09.077	DE03.00.080.00	饮食情况代码 -->
									<value xsi:type="CD" code="{HealthAssessment/diet/value}" displayName="{HealthAssessment/diet/Display}" codeSystem="2.16.156.10011.2.3.2.34" codeSystemName="饮食情况代码表"/>
								</observation>
							</entry>
						</section>
					</component>
