											...
											<representedOrganization>
												...
												<asOrganizationPartOf classCode="PART">
													<wholeOrganization classCode="ORG" determinerCode="INSTANCE">
														...
														<name>
															<xsl:value-of select="HospitalCourse/dischargeDepartment/Display"/>
														</name>
													</wholeOrganization>
...
述-->
	...
	<xsl:template match="treatmentFee/nonSurgeryFee">
		<component>
			<observation classCode="OBS" moodCode="EVN">
	...
	<xsl:template match="treatmentFee/SurgeryFee">
		<component>
			<observation classCode="OBS" moodCode="EVN">
