	...
	<xsl:template match="Diagnosis">
		<component>
			<section>
				...
				<xsl:if test="Westerns/Western[1]/diag/code/Value">
					<entry>
						<observation classCode="OBS" moodCode="EVN">
					...
					<entry>
						<observation classCode="OBS" moodCode="EVN">
							...
							<value xsi:type="CD" code="{TCMSyndrome/TCMSyndrome[1]/syndrome/code/Value}"
								codeSystem="2.16.156.10011.2.3.3.14"
								codeSystemName="中医病证分类与代码表（ GB/T 15657-1995）">
								<xsl:if test="TCMSyndrome/TCMSyndrome[1]/syndrome/code/Display">
									<xsl:attribute name="displayName"><xsl:value-of select="TCMSyndrome/TCMSyndrome[1]/syndrome/code/Display"/></xsl:attribute>
								</xsl:if>
							</value>
						</observation>
					</entry>
