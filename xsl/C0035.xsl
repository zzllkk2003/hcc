...
-->
	...
	<xsl:for-each select="Header/Authenticators/Authenticator">
		<xsl:if test="assignedEntityCode = '接诊医师' or assignedEntityCode = '住院医师' or assignedEntityCode = '主治医师' or assignedEntityCode = '出院医嘱开立人' ">
			<xsl:comment><xsl:value-of select="assignedEntityCode"/>签名</xsl:comment>
			<authenticator>
				<time/>
				<signatureCode/>
				...
				<section>
					...
					<entry>
						<observation classCode="OBS" moodCode="EVN">
							...
							<value xsi:type="ST"><xsl:value-of select="PresentIllnessHistory/presentIllness/Value"/></value>
						</observation>
					</entry>
				</section>
			</component>
				...
				<!--出院情况条目-->
					<entry>
						<observation classCode="OBS" moodCode="EVN">
							...
							<value xsi:type="ST"><xsl:value-of select="HospitalCourse/dischargeCondition/Value"/></value>
						</observation>
				</entry>
			</section>
		</component>
